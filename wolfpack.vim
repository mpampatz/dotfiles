...
""Customized or Changed (...certainly NOT Default)"
""Old Defaults are commented"

hi Normal ctermfg=252 ctermbg=235 cterm=NONE guifg=#f2f8f8 guibg=#242121 gui=NONE
hi Type ctermfg=86 ctermbg=NONE cterm=NONE guifg=#96afff guibg=NONE gui=NONE
hi Comment ctermfg=60 ctermbg=NONE cterm=NONE guifg=#718ea5 guibg=NONE gui=NONE
hi StorageClass ctermfg=60 ctermbg=NONE cterm=NONE guifg=#b9d2ff guibg=NONE gui=NONE
hi PreProc ctermfg=86 ctermbg=NONE cterm=NONE guifg=#f07af0 guibg=NONE gui=NONE
hi Define ctermfg=86 ctermbg=NONE cterm=NONE guifg=#ff64cb guibg=NONE gui=NONE
hi Number ctermfg=135 ctermbg=NONE cterm=none guifg=#be96ff guibg=NONE gui=NONE
hi Float ctermfg=135 ctermbg=NONE cterm=none guifg=#5f4b7f guibg=NONE gui=NONE
